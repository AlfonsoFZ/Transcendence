...
| | `SHOW_GAMES` | `GAMES_LIST` | Client requests a list of available games to join; server sends it. |
...
| **Game Conclusion** | | `GAME_END` | Server declares the game is over and sends the final result (win/loss/draw). |
